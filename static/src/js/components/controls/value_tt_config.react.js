...
var TtConfig = React.createClass({
    render:function() {
	    if ((this.props.UlLength > 0) || (this.props.DlLength > 0)) {
            ...
            return (
                <div>
                    <i className="fa fa-cog" /> <i className="fa fa-arrow-up" /> N:{this.props.UlDatagrams}/L:{this.props.UlLength} <i className="fa fa-arrow-down" /> N:{this.props.DlDatagrams}/L:{this.props.DlLength}/G:{this.props.DlInterval}
                </div>
            );
        } else {
            return (
